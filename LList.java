...
/**
 * Implementing a Linked List data structure to help understand DSA
 * Source: Geeksforgeeks website is the citation source for the code/helping me
 * understand
 */
import java.util.NoSuchElementException;

// Linked list implementation
class LList<E> extends Node<E> {
    private Node<E> head; // Pointer to list header
    private Node<E> tail; // Pointer to last element
    private Node<E> curr; // Access to current element
    ...
    void Node(E it, Node<E> in) {
        e = it;
        in = n;
    }

    void Node(Node<E> next) {
        n = next;
        e = null;
    }
    ...
    // Remove all elements
    public void clear() {
        curr = tail = new Node<E>(null); // Create trailer
        head = new Node<E>(tail); // Create header
        listSize = 0;
    }
    ...
    // Return current element value. Note that null gets returned if curr is at the
    // tail
